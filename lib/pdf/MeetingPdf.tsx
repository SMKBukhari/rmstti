...
import { parseHtmlToPdfElements } from "./htmlToPdfElements";
      ...
      <Page size='A4' style={styles.page}>
        ...
        {meeting.description && (
          <View style={styles.section}>
            ...
            <Text style={styles.value}>
              {parseHtmlToPdfElements(meeting.description)}
            </Text>
          </View>
        )}
            ...
            {meeting.notes.map((note, index) => (
              <View key={index} style={styles.noteContainer}>
                ...
                <Text style={styles.noteContent}>
                  {parseHtmlToPdfElements(note.content)}
                </Text>
              </View>
            ))}
          </View>
          ...
          <View style={styles.section}>
            ...
            {meeting.businessFromLastMeeting && (
              <View style={styles.momSection}>
                ...
                <Text style={styles.momContent}>
                  {parseHtmlToPdfElements(meeting.businessFromLastMeeting)}
                </Text>
              </View>
            )}
            ...
            {meeting.openIssues && (
              <View style={styles.momSection}>
                ...
                <Text style={styles.momContent}>
                  {parseHtmlToPdfElements(meeting.openIssues)}
                </Text>
              </View>
            )}
            ...
            {meeting.newBusiness && (
              <View style={styles.momSection}>
                ...
                <Text style={styles.momContent}>
                  {parseHtmlToPdfElements(meeting.newBusiness)}
                </Text>
              </View>
            )}
            ...
            {meeting.updatesAndAnnouncements && (
              <View style={styles.momSection}>
                ...
                <Text style={styles.momContent}>
                  {parseHtmlToPdfElements(meeting.updatesAndAnnouncements)}
                </Text>
              </View>
            )}
            ...
            {meeting.adjourment && (
              <View style={styles.momSection}>
                ...
                <Text style={styles.momContent}>
                  {parseHtmlToPdfElements(meeting.adjourment)}
                </Text>
              </View>
            )}
          </View>
