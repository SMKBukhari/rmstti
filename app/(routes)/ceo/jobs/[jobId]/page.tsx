...
const JobDetailsPage = async ({ params }: { params: { jobId: string } }) => {
  ...
  return (
    <div className="mx-auto px-4 py-8 sm:px-6 lg:px-8 min-h-screen">
      <Link href="/ceo/jobs" className="inline-flex items-center text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-200 transition-colors mb-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
        <div className="mb-4 sm:mb-0">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Job Setup</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-8">
          <SectionWrapper iconName="LayoutDashboard" title="Customize your Job Details">
        ...
        <div className="space-y-8">
          <SectionWrapper iconName="ListChecks" title="Job Requirements">
            <TagForm initialData={job} jobId={job?.id} user={user} />
          </SectionWrapper>
